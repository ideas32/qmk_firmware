...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    RAISE /*caps*/, STN_S2 /*a*/, STN_KL /*s*/, STN_WL /*d*/, STN_RL /*f*/, STN_ST2 /*g*/, STN_ST4 /*h*/, STN_RR /*j*/, STN_BR /*k*/, STN_GR /*l*/, STN_SR /*;*/, STN_ZR /*'*/, KC_ENT /*ent*/ , KC_PGUP /*pgup, row 3 end*/,
    KC_LSFT /*lsft*/, XXXXXXX /*z*/, XXXXXXX /*x*/, STN_A /*c*/, STN_O /*v*/, XXXXXXX /*b*/, STN_E /*n*/, STN_U /*m*/, XXXXXXX /*,<*/, XXXXXXX /*.>*/, XXXXXXX /*/?*/, KC_RSFT /*rsft*/, KC_LEFT /*left*/, KC_PGDN /*pgdn, row 4 end*/,
    KC_LCTL /*lctl*/, KC_LGUI /*lalt*/, LOWER /*lcmd*/, KC_SPC /*spc*/, KC_RGUI /*rcmd*/, CTLCAPS /*rctl*/, KC_LEFT /*left*/, KC_DOWN /*down*/, KC_RIGHT /*right*/),
    ...
    _______ /*tab*/, _______ /*q*/, _______ /*w*/, _______ /*e*/, _______ /*r*/, _______ /*t*/, _______ /*y*/, _______ /*u*/, _______ /*i*/, _______ /*o*/, _______ /*p*/, _______ /*[{*/, _______ /*]}*/, _______ /*\|*/, _______ /*end, row 2 end*/,
    _______ /*caps*/, _______ /*a*/, _______ /*s*/, _______ /*d*/, _______ /*f*/, _______ /*g*/, _______ /*h*/, _______ /*j*/, _______ /*k*/, _______ /*l*/, _______ /*;*/, _______ /*'*/, QMKFLASH /*ent*/ , _______ /*pgup, row 3 end*/,
    _______ /*lsft*/, _______ /*z*/, _______ /*x*/, _______ /*c*/, _______ /*v*/, _______ /*b*/, _______ /*n*/, _______ /*m*/, _______ /*,<*/, _______ /*.>*/, _______ /*/?*/, _______ /*rsft*/, _______ /*left*/, _______ /*pgdn, row 4 end*/,
    PLOVER /*lctl*/, _______ /*lalt*/, _______ /*lcmd*/, _______ /*spc*/, _______ /*rcmd*/, _______ /*rctl*/, _______ /*left*/, _______ /*down*/, _______ /*right*/),
